...
export type LaunchProfileQuery = (
  ...
  & { launch?: Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'details' | 'mission_name' | 'mission_id' | 'launch_success' | 'launch_date_local' | 'launch_year'>
    & { rocket?: Maybe<(
      { __typename?: 'LaunchRocket' }
...
export type LaunchListQuery = (
  ...
  & { launches?: Maybe<Array<Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'mission_name' | 'launch_year' | 'launch_success' | 'mission_id'>
  )>>> }
);
